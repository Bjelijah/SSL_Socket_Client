...
//    private static String sNameSpace = "http://www.haoweis.com/HomeServices/MCU/";
    private static String sNameSpace = "http://www.haoweis.com/HomeServices/MCU/";//soap 命名空间
//    private static String sNameSpace = "https://192.168.18.245/HomeServices/MCU/";
...
//    private static String sEndPoint = "https://www.haoweis.com:8850/HomeService/HomeMCUService.svc?wsdl";//wsdl url
    private static String sEndPoint = "https://192.168.18.245:8850/HomeService/HomeMCUService.svc?wsdl";
//    private static String sEndPoint = "https://192.168.18.245:8850";
...
//
	...
	public SoapObject initEnvelopAndTransport(SoapObject rpc , String sSoapAction) {
       ...
       // com.howell.activity.FakeX509TrustManager.allowAllSSL(); 
        SSLConection.allowAllSSL(context);//FIXME
        HttpTransportSE transport;
        String url = sEndPoint;//"http://www.haoweis.com:8800/HomeService/HomeMCUService.svc?wsdl";
//        url = "https://192.168.18.245:8861/HomeService/HomeMCUService.svc?wsdl";
//        url = "https://192.168.18.245:8851";
		...
		try {
			...
			Log.e("123", "xml pull parser exception");
			e.printStackTrace();
		}catch (Exception e) {
			Log.e("123", "Exception   transport call error ");
		    e.printStackTrace();
		}
...
//        SoapObject object = initEnvelopAndTransport(rpc,"https://www.haoweis.com/HomeServices/MCU/userLogin");//命名空间+方法名
//        SoapObject object = initEnvelopAndTransport(rpc,"https://192.168.18.245/HomeServices/MCU/userLogin");
//        SoapObject object = initEnvelopAndTransport(rpc,"https://192.168.18.245:8851/HomeServices/MCU/userLogin");
